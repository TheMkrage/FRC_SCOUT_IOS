...
// FPPicker
#define COCOAPODS_POD_AVAILABLE_FPPicker
#define COCOAPODS_VERSION_MAJOR_FPPicker 3
#define COCOAPODS_VERSION_MINOR_FPPicker 2
#define COCOAPODS_VERSION_PATCH_FPPicker 9
